...
<div class="row">
  ...
  <div class="col-md-4">
    <div class="panel panel-default" style='border-radius: 20px'>
      <div class="panel-heading" style='text-align: center; background-color: #7ACBEE; border-radius: 20px'>
        <strong>
          <span>Zapatos recientemente añadidos</span>
        </strong>
      </div>
      <div class="panel-body">
      ...
      <?php foreach ($recent_products as  $recent_product): ?>
            <a class="list-group-item clearfix" style='background-color:#f1ccbe' href="editar_producto.php?id=<?php echo    (int)$recent_product['id'];?>">
                ...
                <?php echo remove_junk(first_character($recent_product['name']));?>
                  <span class="label label-warning pull-right" style='background-color: #7ACBEE; border-radius: 20px'>
