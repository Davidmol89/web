<?php
  ...
  if($session->isUserLoggedIn(true)) { redirect('agregar_venta.php', false);}
?>
  ...
  <div class="login-page">
    ...
    <form method="post" action="auth.php" class="clearfix">
      ...
      <div lass="text-center">
        <button type="submit" class="btn btn-info  pull-right"  style='border-radius: 20px' id="bting">Entrar</button>
        <a href="agregar_usuario.php" class="btn btn-info pull-right" style='margin-right:20px;background-color: #7351ed; border-radius: 20px'>Crear cuenta</a>
